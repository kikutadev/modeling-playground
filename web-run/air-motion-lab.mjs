...
const params=new URLSearchParams(location.search);if(params.has('view'))view=params.get('view');if(params.has('t'))timeInput.value=params.get('t');setCamera();resetAndSimulate(Number(timeInput.value));globalThis.__airMotionLabReady=true;
