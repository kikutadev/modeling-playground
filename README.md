...
[ブラウザでプレイ](https://mizchi.github.io/modeling-playground/game.html) / [ローカルで操作](http://127.0.0.1:5188/game.html)。STRIXを操作し、BASTIONを3機配置した工業区画を探索します。WASD移動・マウス視点・Shiftブースト・Esc停止。建物との衝突とカメラの壁へのめり込み防止を含みます。
...
React Three Fiber／React／TypeScript製。`just game-check`で検証。[操作・構成・制約](docs/game-study.md)。
